---
title: "Review Paper Eco-innovation: version 25-01-2022"
description: |
...
This is the supplementary material of the review paper.
...
```{r, echo=F, warning=F, message=F, eval=F, results='hide'}
folder <- "C:/Users/User/OneDrive - PUJ Cali/PhD/6. P4_Eco-innov_review/2. Data_review"
# Load results
load(paste(folder, "/5_Topic_model_eco-innov/results_LDA_eco-innov_061221.rda", sep=""))
```
...
stm::toLDAvis(h3,
              ...
              lambda.step = 1,
              out.dir = "G:/Mi unidad/Web_pages/review_paper_ecoinnov/review_paper_ecoinnov/topic_modeling_files",
              open.browser = F,
              as.gist = FALSE,
              reorder.topics = T
)
...
```{r, echo=F, warning=F, message=F, eval=F}
LDAvis::serVis(i1, out.dir = tempfile(), open.browser = T)
```
